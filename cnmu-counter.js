        ...
        function formatresults() {
            if (this.timesup == false) {//if target date/time not yet met
               ...
               // var displaystring = "<table border='0'  cellpadding='0' cellspacing='0' height='31' width='154' style=' background-image:url(images/index_towCounter2.jpg); background-repeat:no-repeat;'><tr  ><td   style='width:25%;Color:#3d2611;text-align:center'>" + arguments[0] + "</td><td   style='width:25%;Color:#8a5117;text-align:center'>" + arguments[1] + "</td><td  style='width:25%;Color:#cc9d09;text-align:center'>" + arguments[2] + "</td><td   style='width:25%;Color:#a8951d;text-align:center'>" + arguments[3] + "</td></tr></table>"
                ...
                var displaystring = "<div style='float:left; width:38px;height:26px;text-align:center; margin-top:23px;margin-left:10px;'>" + arguments[0] + "</div><div style='float:left; width:38px;height:26px;text-align:center;margin-top:23px;margin-left:14px;'>" + arguments[1] + "</div><div style='float:left; width:38px;height:26px;text-align:center;margin-top:23px;margin-left:13px; '>" + arguments[2] + "</div><div style='float:left; width:38px;height:26px;text-align:center;margin-top:23px;margin-left:14px;'>" + arguments[3] + "</div>";
