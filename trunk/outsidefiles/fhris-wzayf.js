...
// this function creates a three-column table and adds it to the screen
   var numDisplayed = 0;
   var tocTable = '';
   var tocHead1 = 'إعلانات الوظائف';
   var tocTool1 = 'إضغط للعرض بحسب العنوان';
   var tocHead2 = 'تاريخ الوظيفة';
   var tocTool2 = 'اضغط ليتم الترتيب بحسبا لتاريخ';
   var tocHead3 = 'فئآت الوظائف';
   var tocTool3 = '';
   if (sortBy == "titleasc") { 
      tocTool1 += ' (descending)';
   ...
   tocTable += 'إعلانات الوظائف';
   tocTable += '</td>';
   tocTable += '<td class="toc-header-col2">';
   tocTable += 'تاريخ الوظيفة';
   tocTable += '</td>';
   tocTable += '<td class="toc-header-col3">';
   tocTable += 'فئآت الوظائف';
   tocTable += '</td>';
   tocTable += '</tr>';
   ...
   if (numDisplayed == postTitle.length) {
      var tocNote = '<span class="toc-note">عدد الوظائف ' + postTitle.length + ' وظيفة<br/></span>'; }
   else {
